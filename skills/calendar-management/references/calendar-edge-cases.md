...
Confirm before touching a recurring event. Canceled instance removes that prep item only. Series cancellation is a proposal, not a default action.
...
## Source failure
One calendar source unreachable. Skip it, process others, and surface the skipped source.
All calendar sources unreachable. Do not fabricate availability.
