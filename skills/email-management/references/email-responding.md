Load when drafting or sending a reply.
## Before drafting
...
Check `Memory` for durable voice, signature, counterparty, and source-quirk preferences.
## Draft format
...
\~\~\~text
Draft, \[sending account\] to \[recipient\]
Subject: \[subject\]
\[body\]
Send this?
\~\~\~
