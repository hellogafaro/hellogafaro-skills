...
If the task list is large, cross-person, ambiguous, missing project context, missing owners, missing due dates, or affects workload, create or update the real task records first.

Never duplicate the whole meeting transcript into a task. Preserve the meeting page link, Project relation, owner, due date, source context, constraints, and known success conditions needed to execute it.
