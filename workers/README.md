...
Keep reusable API operations in their owning repo. Accounts Ops provider work belongs in the canonical `hellogafaro/hellogafaro-accounts` repository, whose local checkout is resolved by `accounts-management`.
